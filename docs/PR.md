...
- Keep the game visible on M1 Pro when 8x internal resolution overwhelms Metal: present periodically and warn when rendering falls behind, without silently changing the selected resolution.
